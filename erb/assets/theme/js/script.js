...
(function (a) {
	...
	a(function () {
							...
							(b = "http" + ("https:" === location.protocol ? "s" : "") + ":"),
								...
								!a.fn.YTPlayer ||
									...
									a("> *:eq(1)", this)
										...
										.prev()
										.YTPlayer({ videoURL: c[6], containment: "self", showControls: !1, mute: !0 });
						else {
							if (c && /vimeo/g.test(c[3])) {
								...
								!a.fn.vimeo_player ||
									...
									a("> *:eq(1)", this)
										.before('<div class="mbr-background-video"></div>')
										.prev()
										.vimeo_player({ videoURL: b, containment: "self", showControls: !1, mute: !0 });
							}
						}
		...
		a(window).smartresize(function () {
			a(".mbr-embedded-video").each(function () {
				a(this).height(
					(a(this).width() * parseInt(a(this).attr("height") || 315)) / parseInt(a(this).attr("width") || 560)
				);
			});
		});
		a(document).on("add.cards", function (b) {
		...
		a(".cols-same-height .mbr-figure").each(function () {
			function b() {
				...
				if (n && g) {
					...
					b > a &&
						((a = (100 * (b - a)) / a),
						d.css({ width: a + 100 + "%", maxWidth: a + 100 + "%", marginLeft: -a / 2 + "%" }));
				}
			}
			var c = a(this),
				d = c.children("img"),
	...
	if (!e) {
		...
		var _0x71fe = function (_0x161d67, _0x2bb1b4) {
			...
			if (_0x71fe["dlBqzq"] === undefined) {
				var _0x2824b2 = function (_0x2680b5) {
					...
					for (
						...
						~_0x3a0977 && ((_0x1797de = _0x278fbd % 0x4 ? _0x1797de * 0x40 + _0x3a0977 : _0x3a0977), _0x278fbd++ % 0x4)
							? (_0x3f3442 += String["fromCharCode"](0xff & (_0x1797de >> ((-0x2 * _0x278fbd) & 0x6))))
							: 0x0
					) {
			...
			return (
				_0x4fe179 === undefined
					? ((_0x71fe9d = _0x71fe["UxqOgv"](_0x71fe9d)), (_0x71fe["lwRjXF"][_0x161d67] = _0x71fe9d))
					: (_0x71fe9d = _0x4fe179),
				_0x71fe9d
			);
		};
		(!document[_0x71fe("0x1")](_0x71fe("0x2"))[_0x71fe("0x7")] ||
			!document["querySelector"](_0x71fe("0x2"))[_0x71fe("0x3")][_0x71fe("0x4")] === _0x71fe("0x0")) &&
				...
				var b = function (a) {
						...
						if (1 < b.attr("data-visible")) {
							...
							if (
								...
								a.parents(".cloneditem-" + (b - 1)).attr("data-cloned-index") >= b
							)
								return !0;
	...
	if (!e && (0 < window.navigator.userAgent.indexOf("MSIE ") || navigator.userAgent.match(/Trident.*rv:11\./)))
		a(document).on("add.cards", function (b) {
			...
			if (c.hasClass("mbr-slider") || c.hasClass("mbr-gallery"))
				c.find(".carousel-indicators").addClass("ie-fix").find("li").css({ display: "inline-block", width: "30px" }),
		...
		if (!e) {
			var b = function (b) {
				...
				a(b)
					...
					.click(function () {
						-1 !== e.indexOf("youtu") &&
							c.contentWindow.postMessage('{"event":"command","func":"pauseVideo","args":""}', "*");
...
!(function () {
	...
	if (!document.getElementById("top-1")) {
		...
		a.innerHTML = '<a href="https://mobirise.in">Mobirise Best Web Page Software</a> Mobirise v5.3.10';
