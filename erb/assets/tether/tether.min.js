			...
			i = function n() {
				return "undefined" != typeof e && e > 16
					...
					: void (
							...
							("undefined" != typeof o && (clearTimeout(o), (o = null)), (t = m()), _(), (e = m() - t))
						);
			};
						...
						value: function () {
							...
							if ("scroll-handle" === this.targetModifier) {
								...
								var a = t.height - parseFloat(i.borderTopWidth) - parseFloat(i.borderBottomWidth) - s,
									...
									f = 0;
								408 > a && this.target === document.body && (f = -11e-5 * Math.pow(a, 2) - 0.00727 * a + 22.58),
						...
						"together" === d &&
							(o < w[1] &&
								...
								("bottom" === y.top
									...
									: "top" === y.top && ((o += u), (v.top = "bottom"), (o -= a), (y.top = "bottom"))),
							o + a > w[3] &&
								"bottom" === v.top &&
								("top" === y.top
